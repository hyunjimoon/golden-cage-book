...
| 4 ↔ 8 | [4_시계새장](4_시계새장.md) | [8_장난둥지](8_장난둥지.md) |
...
| ~~★3~~ ✅ | ~~5-8 셸 파일명 변경~~ **결정 완료 (2회 갱신)**: `5_역할둥지` / `6_안개둥지` / `7_언어둥지` / `8_장난둥지` (소설·개념 직결, 본문 제목과 일관) — 옛 (작가·트릭) → 새 (안개·장난) | sync 스크립트 갱신 완료 (web 영문 ch6_author_nest·ch8_trick_nest는 URL 안정성 위해 유지) | — |
