...
## 🗄️ 빚 장부·평가·비틂 2축 (마스터 §3 인용)

> SSOT: `2차소통/🗄️마스터_표와액자.md` §3. 변형 없이 인용.

### Table 2 — 빚 장부 (B 적립 → A 방출 → C 거울)

| 장 | 다(욕망·앞서) | 세(상태·지켜봄) | 저장 에너지=빚 | 동사 |
|:--|:--|:--|:--|:--|
| 1 | 엠마(빌린 욕망) | 르뢰(겸손한 사랑) | *모르고* 빌린 욕망 | 장부를 펴라 |
| 2 | 탄크레디(행동하는 눈) | 살리나(관조의 감옥) | 봐도 *안 뛰는* 마비 | 순서를 타라 |
| 3 | 파늘루(닫힌 확신) | 리외(책임) | *안 고치는* 확신 | 확신을 교정하라 |
| 4 | 방드르디(작란) | 로빈슨(빌린 질서) | 부수고 *안 짓는* 공백 | 다음 불을 피워라 |
| 5 | 자장(frame 공개) | 윈스턴(frame 숨김) | ★멈춤 공백 | frame을 공개하라 |
| 6 | 송 릴링(알면서 입기) | — | 환상 입히기 | 환상을 역이용하라 |
| 7 | 코르넬리우스(분포) | 복스텔(한 점) | 창살=사랑의 조건 | 확률적으로 생각하라 |
| 8 | 아우구스토(피조물) | 우나무노(작가) | novela→nivola | 선을 넘어라 |
| 9 | 일연(正→遺) | 무극(협업) | 명명 책임 | 의미를 만들어라 |
| 10 | 다(뒤돌아봄) | 세(궤도 발현) | 자리 이동 청산 | 자리를 바꿔 갚아라 |

### Table 3 — 5렌즈 종합 평가 (b2o 발판, 2026-06-13)

| 장 | 작품 | 거울 | 다세 | 접근성 | 완성도 | 종합 |
|:--|:--:|:--:|:--:|:--:|:--:|:--:|
| 1 | 5 | 5 | 5 | 4 | 5 | **96** |
| ★5 | 5 | 5 | 4.5 | 4.5 | 5 | **96** |
| 2 | 4.5 | 4.5 | 5 | 4 | 4.5 | 90 |
| 3 | 5 | 4.5 | 4.5 | 3.5 | 4.5 | 88 |
| 6 | 4.5 | 5 | 4.5 | 3.5 | 4.5 | 88 |
| 4 | 4.5 | 4.5 | 4.5 | 3.5 | 4 | 84 |
| 7 | 4.5 | 5 | 4 | 2.5 | 4 | 🔴80 |
| 8 | 4.5 | 4.5 | 4.5 | 3 | 3.5 | 🔴80 |
| 9 | 4.5 | 5 | 4 | 2.5 | 4 | 🔴80 |
| 10 | 4 | 4.5 | 4.5 | 4 | 2.5 | 🔴78 |

→ 시각화: `interactive/00_eval_1-10장평가_b2o발판.html`

### Table 4 — 비틂 2축 (부록2 = 책 엔진 = 7장 방법론)

| 축 | 비틂 | 전 → 후 | 실험 |
|:--|:--|:--|:--|
| **시공간** | 공간 → 시간 | 동시 비교 → 어제보다 나음 추적 | 비틂2 |
| | 타他 → 내 | 남의 좌표 → 내 좌표 | 비틂3 |
| **긍정/부정** | 부정 → 긍정 | 적의 피로 물든 칼→과거 고통을 미래 연료로 | 비틂1 |
| | 긍정 → 부정 | 모든 것 유지하려면 모든 것 변해야→하나 안 변하면 하나 잃는다 | calibration |
