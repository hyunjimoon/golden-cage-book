...
**일연:** 한 가지 — *내가 살던 환경에서 frame 공개는 한 권의 책이었소.* 종이에 새기고, 목판으로 박고, 절에서 절로 옮겨 — *수십 년 만에 한 사람의 책상*에 도착했소. 2026년 그대들의 환경에서는 — *GitHub commit과 changelog*. *수십 년*이 *수 분*이 되었소. **같은 동작, 다른 매체.** 5장 오웰이 *결핵*으로, 8장 뒤마가 *피부*로 회전축을 증언했다면 — 9장 나는 *책의 형식*으로 증언하오. 그러나 *동작*은 하나요 — *옆에 두기*. 그대들의 commit 하나하나가 — *내가 인각사에서 한 일과 같은 동작*이오.

> **격자** · 🟢 시대: 1281 몽골 7차 침입 · 정사 불교 배제 │ 🔴 pain: 9세 출가 · 노년 외로움 · *正* 옆에 *遺* │ ★ 작품: ***삼국유사*** — 옆자리 framing으로 정사 보완

*(일연 퇴장. 세다만 남는다.)*

**세다:** 일연이 *책의 형식*으로 *옆자리*를 만들었다면, 2026년 누군가는 *commit의 형식*으로 옆자리를 만들어요. 같은 동작, 다른 매체. 5장 오웰(결핵·1948)·8장 뒤마(피부·1850)·9장 일연(책·1281) — 세 증인이 회전축의 세 매질을 보여줬어요. **그리고 일연이 마지막에 던진 한 마디** — *그대들 곁에도 다음 trickster가 와야 하오.* 그것이 9장의 마지막 호명으로 곧장 이어져요 — *당신의 다음 사람은 누구입니까?*

> **세다의 일기 (보너스)**
> 일연이 잠깐 들어왔다 나갔다. 70대 노승의 외로움과 무극·민간 사고의 협업을 같이 공개하면서 — *삼국유사가 한 사람의 책이 아니었음*을 직접 증언했다. 1281년 인각사의 노승이 2026년 책의 본문 안으로 들어와 — *옆자리 만들기*가 frame 공개의 1281년 형태였음을 보여줬다. *frame 공개가 한 권의 책이 되는 환경* (1281 인각사·목판) ↔ *frame 공개가 commit이 되는 환경* (2026 GitHub·changelog). 그 환경 차이가 9장 회전축이다. 5장 오웰이 *결핵으로*, 8장 뒤마가 *피부로*, 9장 일연이 *책으로* — 세 매질, 한 동작. *옆에 두기.* 회전축이 회전하려면, 회전축 자신도 *멈추지 않고 지나가야* 한다. 1281년 인각사에서 2026년 GitHub로 — 한 발자국 더. 그리고 일연이 마지막에 던진 *그대들 곁에도 다음 trickster가 와야 하오* — 그 한 마디가 이 장 §4.4의 *당신의 다음 사람은 누구입니까?*로 이어진다. 회전축이 회전축을 호명한다.
...
**세다:** 첫째, **토스** (비바리퍼블리카). 2015년 송금 앱, 2021년 토스증권. *증권*이라는 신성을 훔쳤어요. HTS의 격자, MTS의 호가창 — *전문가의 자리*였어요. 토스증권은 그 default를 거절했어요. 한 종목 한 화면, 적당한 친절. *주식 1주 이하* 소수점 매매 — 거래 단위를 다시 명명. **Phase 2 = *주식 사기를 송금처럼*.**

**세다:** 둘째, **카카오뱅크** (2017) — *은행 자리는 그대로 두고 옆방으로 이사*. 라이선스·예금자보호·이체 *기능 100% 보존*. 바뀐 건 *어디 사는지*뿐 — *은행 앱*에서 *카카오톡 옆*. *예금주→사용자→친구* 호명 비틂. **Phase 2 = *통장 = 메신저 친구*.** 부수기 0%, 옮기기 100%.[^카뱅]

**세다:** 셋째, **SK Hynix HBM**. 2012년 *Hynix → SK Hynix* 사명. 더 깊은 비틂 — *DRAM commodity 회사* → *AI 인프라 핵심 부품 회사*. 2013년 HBM(High Bandwidth Memory) 세계 최초 양산. 2024년 NVIDIA H100·B100의 주력 공급사. 영업이익 23.5조 — 삼성을 제치고 DRAM 1위. *메모리의 자리가 옆자리로 이동* — *멀리 모든 데이터*에서 *가까이 필요한 데이터*로.

**세다:** 미국 짝은 **Groq**. *GPU → LPU* (Graphics → Language Processing Unit). *G*를 *L*로 한 칸 비틂. 6장 *novela → nivola*, 8장 Hyde의 *Bailey → Douglass*, 그리고 *GPU → LPU* — **세 비틂이 동일 trickster 원리.** 형식 → 정체성 → 컴퓨팅 substrate.

**세다:** 8장의 가장 깊은 자리 — *반도체 architecture가 보르헤스 《기억의 천재 푸네스》(1942) 신화의 anti-thesis*. Funes는 *모든 것을 기억하는 자가 신이 된다*는 신화. 그런데 — clockspeed 2배가 시간 1/2를 만들지 않고(병렬성 필요), 모든 정보 동등 접근이 빠른 인출을 만들지 않고(메모리 계층 필요), 데이터 양과 학습 품질이 비례하지 않아요(평가-조타 인출 필요). 현대 반도체는 *Funes의 세 신화*를 거꾸로 짓는 architecture. **trickster가 architecture가 됐어요.** *한 글자 비틂이 한 시장을 짓는다.*
...
**세다:** 일연이 1281년 *유사*를 편찬한 자리와 — 1857년 Douglass가 노예해방 25주년에 외친 자리는, 같은 *권력 매개* 동작이에요. 둘 다 *기록·연설로 권력을 협상*했어요. 일연은 *책의 형식*으로, Douglass는 *입의 형식*으로.

**세다:** 8장에서 코르넬리우스가 *유리 한 장*으로 평화를 *싸워 지켰다면* — 9장은 *말 한 줄*로 평화를 *함께 지키는* 자리예요. **매개가 기술에서 협력으로 옮겨가는 자리.** 8장 paradox(전쟁=평화 | 기술)가 9장에서 *함께 마심의 paradox*로 완결됩니다.
...
**세다:** 8장에서 *기술이 매개*했다면, 9장은 *협력자가 매개*해요. 일연 옆에 무극이 있었어요. Douglass 옆에 Garrison·Lloyd가 있었어요. *명명은 혼자 하면 새장, 둘이 하면 둥지.* 매개자가 있어야 *명명*이 다음 세대에 도달해요.
