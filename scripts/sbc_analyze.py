...
두 화자가 있다 (ch0_characters.md 정식 정의):
- 다(DA): 뛰어본 쪽. 낭만으로 거는 사람. 장마다 다른 정식 인물을 거울로 본다 — 1장 엠마, 2장 탄크레디, 3장 타루, 4장 방드르디.
- 세(SE): 지켜본 쪽. 세상을 읽는 사람. 1·2장 살리나에 가깝고, 3·4장 리외에 닿는다.
...
또한:
- daPos: 다 아크 위치 (0=엠마와 같은 자리, 100=방드르디 곁)
- sePos: 세 아크 위치 (0=살리나와 같은 자리, 100=리외에 도착)
